...
def main():
        try:
                ...
                if args.fastq_r2=='': #single end reads
                    ...
                    if not args.trim_sequences:
                        ...
                        if TRIMMOMATIC_STATUS:
                                raise Exception('TRIMMOMATIC failed to run, please check the log file.')
                    ...
                    if FLASH_STATUS:
                        raise Exception('Flash failed to run, please check the log file.')
                ...
                if NEEDLE_OUTPUT:
                        raise Exception('Needle failed to run, please check the log file.')
